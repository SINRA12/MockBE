...
const DynamicRequestCallbackQparams = require('./dynamicRequestCallbackQparams')
...
const mockSchema = new Schema({
    ...
    dynamicRequestCallbackQparams:[
        {
            type: Schema.Types.ObjectId,
            ref: 'DynamicRequestCallbackQparams' 
        }
...
mockSchema.post('findOneAndDelete', async function (doc) {
    if (doc) {
        await DynamicRequestCallbackQparams.deleteMany({
            _id: {
                $in: doc.dynamicRequestCallbackQparams
            }
        })
    }
})
